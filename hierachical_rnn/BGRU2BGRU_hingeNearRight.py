...
class Hierachi_RNN(object):
    ...
    def model_constructor(self, wemb_size = None):
        ...
        for i in range(self.batchsize - 1):
            ...
            self.cosine_column_ls.append(self.batch_cosine(self.train_encodinglayer_vecs[-1], T.roll(self.train_encodinglayer_vecs[-1], shift = (i + 1), axis = 0)).reshape((-1,1)))
