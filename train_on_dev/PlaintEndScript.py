...
for l in range(5):
    f = open('./PlaintEnd'+str(l)+'.job','w')
    f.write('#!/bin/bash\n')
    f.write('#$ -S /bin/bash\n')
    f.write('#$ -M jontsai@uchicago.edu\n')
    f.write('#$ -N PlaintEnd'+str(l)+'\n')
    f.write('#$ -m beasn\n')
    f.write('#$ -o PlaintEnd'+str(l)+'.out\n')
    f.write('#$ -e PlaintEnd'+str(l)+'.err\n')
    f.write('#$ -r n\n')
    f.write('#$ -cwd\n')
    ...
    f.write('/home-nfs/jontsai/anaconda/bin/python plaint_rnn_end.py \\\n')
