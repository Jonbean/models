...
class Hierachi_RNN(object):
    def __init__(self, 
        ...
        self.best_val_model_save_path = '/share/data/speech/Data/joncai/dev_best_model/HierAtt_best_model_'+self.saving_path_suffix+'.pkl' 
    ...
    def eva_func(self, val_or_test):
        ...
        if self.loss_type == "hinge":
            ...
            if val_or_test == 'val' and self.best_val_accuracy <= acc:
                ...
                self.record_flag = False
                with open('./Attention_test_score_record_matrix'+self.saving_path_suffix+'.pkl','w') as f:
                    pickle.dump(self.test_score_record_matrix, f)
            return acc
