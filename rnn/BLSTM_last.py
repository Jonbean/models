...
class BlstmEncoder(object):
    ...
    def build_model(self, WordEmbedding_Init = None):
        ...
        l_lstm_last = lasagne.layers.SliceLayer(l_lstm, -1, 1)
        l_lstm_back_last = lasagne.layers.SliceLayer(l_lstm_back, -1, 1)
        l_sum = lasagne.layers.ElemwiseSumLayer([l_lstm_last, l_lstm_back_last])
