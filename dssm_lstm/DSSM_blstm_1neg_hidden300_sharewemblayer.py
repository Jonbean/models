...
class DSSM_BLSTM_Model(object):
    def __init__(self):
        ...
        self.best_val_model_save_path = './BLSTM_neg1_300_sharewemb_best_val_model_params.pkl'
        self.best_test_model_save_path = './BLSTM_neg1_300_sharewemb_best_test_model_params.pkl'
