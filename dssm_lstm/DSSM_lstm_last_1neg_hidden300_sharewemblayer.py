...
class DSSM_LSTM_Model(object):
    def __init__(self):
        ...
        self.best_val_model_save_path = './best_models_params/LSTM_last_neg1_300_sharewemb_best_val_model_params.pkl'
        self.best_test_model_save_path = './best_models_params/LSTM_last_neg1_300_sharewemb_best_test_model_params.pkl'
    ...
    def model_constructor(self, wemb_matrix_path = None):
        ...
        self.wemb_layer = LSTM_last_Encoder.LstmEncoder(300)
