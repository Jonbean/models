    ...
    def begin_train(self):
        ...
        for epoch in range(N_EPOCHS):
            ...
            for batch in range(max_batch):
                ...
                main_cost, liar_cost, liar_awayfrom_mean, prediction1, prediction2 = self.train_func(train_story_matrices[0], train_story_matrices[1], train_story_matrices[2],
                                                               train_story_matrices[3], train_end_matrix,
                                                               train_story_mask[0], train_story_mask[1], train_story_mask[2],
                                                               train_story_mask[3], train_end_mask)
            ...
            print "total liar away from mean neg end cost: "+str(total_liar_away_from_mean/max_batch)
