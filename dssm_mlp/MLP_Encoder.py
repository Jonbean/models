    ...
    def build_model(self, input_dim):
        ...
        if self.layer3_units != None:
            ...
            l_hid3 = lasagne.layers.DenseLayer(l_hid2, num_units=self.layer3_units,
                                            ...
                                            W=lasagne.init.GlorotUniform())
            self.output = l_hid3
            self.all_params = lasagne.layers.get_all_params(l_hid3)
            ...
            self.output = l_hid2
            self.all_params = lasagne.layers.get_all_params(l_hid2)
        else:
            self.output = l_hid1
            self.all_params = lasagne.layers.get_all_params(l_hid1)